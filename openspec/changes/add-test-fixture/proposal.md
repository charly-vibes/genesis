...
A `genesis::test` module provides reusable fixtures so every tool writes
...
Runs the tool as a subprocess in the fixture directory. This is the
...
- **New capability**: `test` — scratch fixtures for testing and dogfooding.
- **Affected code**: new `src/test/` module in genesis. Downstream tools
